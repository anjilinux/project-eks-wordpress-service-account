...
helm install --name wp-prod --namespace wp-prod -f wordpress_parameters-prod.yaml stable/wordpress

# Install wordpress on development environment
helm install --name wp-dev --namespace wp-dev -f wordpress_parameters-dev.yaml stable/wordpress
